...
import WorldMap from './views/mapWorld'; //taco commited here, map graph
import StreamGraph from './views/StreamGraph'; //taco commited here, stream colored graph
import PacketBubbleChart from './views/PackedBubbleChart'; //taco commited here, packed bubble chart
import GroupedBubbleChart from './views/GroupedBubbleChart';//taco commited here, grouped bubble chart
...
const App = () => (
  ...
  <Router>
    <div>
      ...
      {/* ^ ne radi puca neki nemoguc error */}
      <Route path="/packedbubble" component={PacketBubbleChart} />
      <Route path="/groupedbubble" component={GroupedBubbleChart} />
